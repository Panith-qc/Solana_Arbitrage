...
const ProductionTradingDashboard = () => {
    ...
    if (showWalletIntegration) {
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <WalletIntegration onWalletDisconnect={handleWalletDisconnect} onRefreshBalance={handleRefreshBalance}/>

          <div className="text-center">
            <Button onClick={() => setShowWalletIntegration(false)} variant="outline" className="border-blue-500/50 text-blue-400 hover:bg-blue-500/20">
              Back to Dashboard
            </Button>
          </div>
        </div>
    ...
    if (showSettings) {
        return (<TradingSettingsPanel onClose={() => setShowSettings(false)}/>);
    }
    return (<div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <Button onClick={() => setShowWalletIntegration(true)} variant="outline" size="sm" className="border-blue-500/50 text-blue-400 hover:bg-blue-500/20">
                  <Wallet className="w-4 h-4 mr-2"/>
                  {walletState.isConnected ? 'Wallet Settings' : 'Connect Wallet'}
                </Button>
                <Button onClick={() => setShowSettings(true)} variant="outline" size="sm" className="border-purple-500/50 text-purple-400 hover:bg-purple-500/20">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-2">
                  ...
                  <Switch checked={isScanning} onCheckedChange={(checked) => {
            if (checked) {
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Switch checked={config.trading.autoTradingEnabled} onCheckedChange={(checked) => {
            tradingConfigManager.updateSection('trading', { autoTradingEnabled: checked });
              ...
              <div className="flex items-center space-x-4">
                ...
                {isScanning && (<Badge className="bg-green-500/20 text-green-400 border-green-500/50">
            ...
            <Card className="bg-black/20 border-green-500/30">
              <CardHeader>
                <CardTitle className="text-green-400 flex items-center">
                  ...
                  {config.trading.autoTradingEnabled && (<Badge className="ml-2 bg-purple-500/20 text-purple-400 border-purple-500/50">
                ...
                {opportunities.length === 0 ? (<div className="text-center py-8">
                    ...
                    opportunity.riskLevel === 'MEDIUM' ? 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50' :
                        'bg-red-500/20 text-red-400 border-red-500/50'}`}>
                          ...
                          <Button onClick={() => executeStrategyTrade(opportunity)} disabled={executingTradeId === opportunity.id} size="sm" className="bg-green-600 hover:bg-green-700 text-white disabled:opacity-50">
        ...
        {tradeHistory.length > 0 && (<Card className="bg-black/20 border-purple-500/30">
            ...
            <CardContent>
              <div className="space-y-3 max-h-64 overflow-y-auto">
                {tradeHistory.slice(0, 10).map((trade, index) => (<div key={index} className="bg-black/30 rounded-lg p-3 border border-gray-700">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        {trade.success ? (<CheckCircle className="w-4 h-4 text-green-500"/>) : (<XCircle className="w-4 h-4 text-red-500"/>)}
                        <div>
                          <div className="flex items-center space-x-2">
                          ...
                          <div className="flex items-center space-x-4 mt-1 text-sm">
                            {trade.profitUsd && (<span className="text-green-400">
                          ...
                          {trade.error && (<span className="text-red-400 text-sm">{trade.error}</span>)}
                        </div>
                      </div>
                      <div className="text-right">
                        <Badge variant="outline" className={trade.success ? 'border-green-500 text-green-400' :
...
//# sourceMappingURL=ProductionTradingDashboard.js.map