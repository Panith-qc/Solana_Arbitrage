...
const ProductionTradingDashboard = () => {
    ...
    const handleWalletConnect = (walletType, privateKey) => {
    ...
    const handleStartAllStrategies = useCallback(async () => {
        ...
        setIsScanning(true);
        try {
            await strategyEngine.startAllStrategies(walletState.balance, (strategyOpportunities) => {
