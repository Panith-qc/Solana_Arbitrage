...
import { realJupiterTrading, MEVOpportunity } from '../services/realJupiterTrading';
...
const RealTradingDashboard: React.FC = () => {
  ...
  // Execute real trade
  const executeRealTrade = async (opportunity: MEVOpportunity) => {
    if (!connected || !publicKey) {
        ...
        {showSettings && (
          <Card className="bg-black/20 border-purple-500/30">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="number"
                    step="0.001"
                    value={tradingSettings.minProfitUsd}
              ...
              {tradingSettings.autoTradingEnabled && (
                ...
                {opportunities.map((opportunity) => (
                  <div key={opportunity.id} className="bg-black/30 rounded-lg p-4 border border-gray-700">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        onClick={() => executeRealTrade(opportunity)}
                        disabled={executingTradeId === opportunity.id || !connected}
                        size="sm"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          {trade.error && (
                            <span className="text-red-400 text-sm">Real Error: {trade.error}</span>
                          )}
                        </div>
                      </div>
