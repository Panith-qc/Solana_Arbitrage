...
const TradingControls: React.FC<TradingControlsProps> = ({
  walletBalance = { sol: 0, usdc: 0, usdt: 0 },
  onScannerToggle,
  onOpportunityFound
}) => {
  const [isScanning, setIsScanning] = useState(false);
  const [scannerStatus, setScannerStatus] = useState<'idle' | 'starting' | 'active' | 'stopping'>('idle');
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              size="lg"
              disabled={scannerStatus === 'starting' || scannerStatus === 'stopping'}
      ...
      {scannerStatus === 'active' && scanCount > 0 && (
