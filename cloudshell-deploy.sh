...
create_secret "helius-rpc-url" "https://mainnet.helius-rpc.com/?api-key=YOUR_HELIUS_API_KEY"
create_secret "helius-api-key" "YOUR_HELIUS_API_KEY"
create_secret "jupiter-ultra-api-key" "YOUR_JUPITER_ULTRA_API_KEY"
